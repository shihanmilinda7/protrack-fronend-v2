    ...
    if (!projectAssignSave || !timeAllocationSave) {
      ...
      switch (btn) {
        ...
        case "timelogs":
          ...
          break;
        case "sign-out":
          webSocket.emit("logout", { message: "logout", room: "adminroom" });
          await setNewLogout();
          await signOut();
          window.location.href = "/";
          break;
      ...
      >
        ...
        >
          ...
          >
            ...
            <li className={userRole == "systemadmin" ? "" : "hidden"}>
              <button
                onClick={() => navButtonHandler("systemadmin-page")}
                className={
                  currentRoute === "/systemadmin-page"
                    ? activeStyle
                    : nonActiveStyle
                }
              >
